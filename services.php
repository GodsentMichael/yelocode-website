                ...
                <div class="row flex-row-reverse">
                    <div class="col-md-6 text-right">
                        <div class="pq-header-social text-right">
                            <ul>
                                <li><a href="services.html#"><i class="fab fa-facebook-f"></i></a></li>
                                <li><a href="services.html#"><i class="fab fa-github"></i></a></li>
                                <li><a href="services.html#"><i class="fab fa-instagram"></i></a></li>
                                <li><a href="services.html#"><i class="fab fa-skype"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6">
                                ...
                                <div id="pq-menu-contain" class="pq-menu-contain">
                                    <ul id="pq-main-menu" class="navbar-nav ml-auto">
                                        <li class="menu-item manu-item-has-children">
                                            <a href="services.html#">Home</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="services.html#">Muti Page</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item">
                                                ...
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="services.html#">One Page</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item">
                                        ...
                                        <li class="menu-item">
                                            <a href="services.html#">Services</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                            <ul class="sub-menu">
                                                <li class="menu-item">
                                        ...
                                        <li class="menu-item current-menu-item">
                                            <a href="services.html#">Pages</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                            <ul class="sub-menu">
                                                <li class="menu-item">
                                        ...
                                        <li class="menu-item">
                                            <a href="services.html#">Portfolio</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="services.html#">Types</a><i
                                                ...
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="services.html#">Columns</a><i
                                                        class="fa fa-chevron-down pq-submenu-icon"></i>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item">
                                        ...
                                        <li class="menu-item">
                                            <a href="services.html#">Blog</a><i class="fa fa-chevron-down pq-submenu-icon"></i>
                                            <ul class="sub-menu">
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="services.html#">Grid Style</a><i
                                                        class="fa fa-chevron-down pq-submenu-icon"></i>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item">
                                                ...
                                                <li class="menu-item menu-item-has-children">
                                                    <a href="services.html#">Blog Sidebar</a><i
                                                        class="fa fa-chevron-down pq-submenu-icon"></i>
                                                    <ul class="sub-menu">
                                                        <li class="menu-item">
                            ...
                            <div class="widget">
                                ...
                                <div class="menu-useful-link-container">
                                    <ul id="menu-usefull-link" class="menu">
                                        <li>
                                            <a href="services.html#">Fact Search Engine</a>
                                        </li>
                                        <li>
                                            <a href="services.html#">Learn and Code</a>
                                        </li>
                                        <li>
                                            <a href="services.html#">Video Sharing Website</a>
                                        </li>
                                        <li>
                                            <a href="services.html#">File &amp; URL Scanner</a>
                                        </li>
                                        <li>
                                            <a href="services.html#">Online Software Package</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <span class="pq-copyright"><a target="_blank" href="services.html#"> Copyright 2022 Techtrix All Rights
                                    Reserved.</a></span>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="pq-footer-link">
                                <ul>
                                    ...
                                    <li><a href="services.html#">Term Of Use</a></li>
