            ...
            <rs-module id="rev_slider_14_1" data-version="6.3.2">
                <rs-slides>
                    <rs-slide data-key="rs-41" data-title="Slide" data-thumb="rev/assets/banner-50x100.jpg"
                        ...
                        <a id="slider-14-slide-41-layer-8" class="rs-layer rev-btn" href="contact-us.html"
                    ...
                    <rs-slide data-key="rs-46" data-title="Slide" data-thumb="rev/assets/banner4-50x100.jpg"
                        ...
                        <!-- #fd4a18 -->
                        <a id="slider-14-slide-46-layer-8" class="rs-layer rev-btn" href="contact-us.html"
                            target="_self" data-type="button" data-rsp_ch="on"
                    ...
                    <rs-slide data-key="rs-45" data-title="Slide" data-thumb="rev/assets/banner5-50x100.jpg"
                        ...
                        <!-- #ffdf40 -->
                        <a id="slider-14-slide-45-layer-8" class="rs-layer rev-btn" href="contact-us.html"
                            target="_self" data-type="button" data-rsp_ch="on"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-6 col-lg-6 mt-4 mt-lg-0">
                    <div class="about-us-img">
                        ...
                        <!-- <img src="images/client/ifeanyi2.jpg" class="pq-image5 animated wow fadeInLeft" alt="" style="height: 600px"; width="300px"> -->
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="whyus">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="pq-section pq-style-1 text-center">
                        <h5 class="pq-section-title" id="service" data-high_text="Services"
                            data-title_text="We Provide Every Type Of Service" data-rough_color="#ffdf40"
                            data-rough_type="underline">We Provide Every Type Of Service</h5>
                        <p class="pq-section-descrition">Lorem Ipsum is simply dummy It is a long established fact that
                            a reader will be distracted by the readable content of a page when looking at its layout.
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-5">
                <div class="col-xl-4 col-lg-6 col-md-6">
                    <div class="pq-fancy-box pq-fancybox-1">
                        ...
                        <div class="pq-fancybox-info">
                            ...
                            <p>There are many variaons of passages Lorem Ipsum available, but majority have suffered
                                alteration in…</p>
                            <div class="pq-btn-container">
                                <div class="pq-button-block">
                ...
                <div class="col-lg-12 text-center">
                    <p class="mb-0 fw-bolder">Success Your Technology. <a href="main-home.html"
                            class="pq-text-primary">Take A Challenge!</a></p>
                </div>
            </div>
        </div>
    </section>
                            ...
                            <div class="pq-list-content">
                                <ul class="pq-list-info ">
                                    ...
                                    <li class="">
                                        ...
                                        <span>HTML, CSS, JAVASCRIPT<br>BOOTSTRAP,JQUERY, React/Vue <br>20
                                            Projects</span><br>
