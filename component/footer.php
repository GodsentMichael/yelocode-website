                        ...
                        <div class="widget">
                            ...
                            <div class="menu-useful-service-links-container">
                                <ul id="menu-useful-service-links" class="menu">
                                    <li>
                                        <a href="services.php">Software Development</a>
                                    </li>
                                    <li>
                                        <a href="services.php">Web Development</a>
                                    </li>
                                    <li>
                                        <a href="services.php">Mobile Development</a>
                                    </li>
                                    <li>
                                        <a href="services.php">App Development</a>
                                    </li>
                                    <li>
                                        <a href="services.php">QA Testing</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="pq-widget-menu widget">
                            ...
                            <div class="pq-footer-recent-post">
                                ...
                                <div class="pq-footer-recent-post-info">
                                    <h6><a href="#">11, Elekahia Road, Rebisi Port Harcourt, Rivers State, Nigeria</a>
                                    </h6>
                                </div>
                            </div>
                            <div class="pq-footer-recent-post">
                                ...
                                <div class="pq-footer-recent-post-info">
                                    <h6><a href="#">Hello@yelocodesystems.com</a>
                                </div>
                            </div>
                            <div class="pq-footer-recent-post">
                                <div class="pq-footer-recent-post-media">
