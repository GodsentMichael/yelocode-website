                            ...
                            <div class="widget">
                                ...
                                <div class="pq-footer-social">
                                    <ul>
                                        ...
                                        <li><a href="home-modern.html#"><i class="fab fa-github"></i></a></li>
                                        <li><a href="home-modern.html#"><i class="fab fa-instagram"></i></a></li>
                                        <li><a href="home-modern.html#"><i class="fab fa-skype"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="widget">
                                ...
                                <div class="menu-useful-link-container">
                                    <ul id="menu-usefull-link" class="menu">
                                        <li>
                                            <a href="home-modern.html#">Fact Search Engine</a>
                                        </li>
                                        <li>
                                            <a href="home-modern.html#">Learn and Code</a>
                                        </li>
                                        <li>
                                            <a href="home-modern.html#">Video Sharing Website</a>
                                        </li>
                                        <li>
                                            <a href="home-modern.html#">File &amp; URL Scanner</a>
                                        </li>
                                        <li>
                                            <a href="home-modern.html#">Online Software Package</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <span class="pq-copyright"><a target="_blank" href="home-modern.html#"> Copyright 2022 Techtrix All Rights
                                    Reserved.</a></span>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="pq-footer-link">
                                <ul>
                                    <li><a href="home-modern.html#">Career</a></li>
                                    <li><a href="home-modern.html#">Term Of Use</a></li>
                                    <li><a href="home-modern.html#">Privacy Policy</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
